...
In order to pass this course, you \underline{\textbf{must write a report and present this assignment}}. If you complete the code and report and submit them, but \textit{do not present}, then you will \underline{\textbf{fail the course}}. Please see section \ref{sec:submission} for a detailed description of everything you must submit.
