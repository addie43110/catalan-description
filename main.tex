...
In order to pass this course, you \underline{\textbf{must write a report and present this assignment}}. If you complete the code and report and submit them, but \textit{do not present}, then you will {\textbf{not get credit for the Abschluss\-pr\"ufung im Rahmen des Programmierprojekts}}. Please see section \ref{sec:submission} for a detailed description of everything you must submit, and \url{https://ekvv.uni-bielefeld.de/sinfo/publ/modul/420520482} for the details of the module.

As soon as you have uploaded your written report and your sources to Artemis, you can (must) schedule an individual presentation with your TA (details in section \ref{sec:pres}). You are responsible for contacting your TA to schedule your presentation. The deadline for scheduling a presentation with your TA is Friday, 30.01.2025, 16.00. The deadline for presenting to your TA is 06.02.2025.  

There will be a lecture on Tuesday, January 6th which will introduce the assignment in more detail.
